...
<header id="site-header" role="banner">
	<div class="header-inner">
		<a href="<?php echo esc_url( $ortsverein_nv_home_url ); ?>" class="brand" aria-label="<?php esc_attr_e( 'AWO Ortsverein Neukirchen-Vluyn – Startseite', 'ortsverein-nv' ); ?>">
			<img src="<?php echo esc_url( $ortsverein_nv_logo_url ); ?>" alt="<?php esc_attr_e( 'AWO Ortsverein Neukirchen-Vluyn', 'ortsverein-nv' ); ?>" width="64" height="64" class="brand-icon" decoding="async">
